...
driver.get("https://bdgame.in/code/Pytho_code_8.html")
time.sleep(5)
...
with open("pythoncode8.py", "w") as file:
    file.write(code)
driver.quit()
result = subprocess.run(["python3", "pythoncode8.py"], capture_output=True, text=True)
