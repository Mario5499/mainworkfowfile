...
driver.get("https://bdgame.in/code/Pytho_code_3.html")
time.sleep(5)
...
with open("pythoncode3.py", "w") as file:
    file.write(code)
driver.quit()
result = subprocess.run(["python3", "pythoncode3.py"], capture_output=True, text=True)
