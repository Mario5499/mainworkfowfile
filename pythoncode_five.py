...
driver.get("https://bdgame.in/code/Pytho_code_5.html")
time.sleep(5)
...
with open("pythoncode5.py", "w") as file:
    file.write(code)
driver.quit()
result = subprocess.run(["python3", "pythoncode5.py"], capture_output=True, text=True)
