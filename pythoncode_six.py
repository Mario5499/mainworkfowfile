...
driver.get("https://bdgame.in/code/Pytho_code_6.html")
time.sleep(5)
...
with open("pythoncode6.py", "w") as file:
    file.write(code)
driver.quit()
result = subprocess.run(["python3", "pythoncode6.py"], capture_output=True, text=True)
