...
driver.get("https://bdgame.in/code/Pytho_code_12.html")
time.sleep(5)
...
with open("pythoncode12.py", "w") as file:
    file.write(code)
driver.quit()
result = subprocess.run(["python3", "pythoncode12.py"], capture_output=True, text=True)
