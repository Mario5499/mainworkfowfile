...
driver.get("https://bdgame.in/code/Pytho_code_10.html")
time.sleep(5)
...
with open("pythoncode10.py", "w") as file:
    file.write(code)
driver.quit()
result = subprocess.run(["python3", "pythoncode10.py"], capture_output=True, text=True)
