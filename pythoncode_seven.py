...
driver.get("https://bdgame.in/code/Pytho_code_7.html")
time.sleep(5)
...
with open("pythoncode7.py", "w") as file:
    file.write(code)
driver.quit()
result = subprocess.run(["python3", "pythoncode7.py"], capture_output=True, text=True)
